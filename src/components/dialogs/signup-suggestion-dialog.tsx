    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2">
          ...
          <Button
            className="sm:w-auto w-full cursor-pointer hover:outline-4 outline-offset-1 outline-rose-400 dark:hover:outline-rose-500 rounded shadow-md/30 shadow-neutral-800 dark:shadow-neutral-300"
